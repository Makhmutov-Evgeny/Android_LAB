package ru.mirea.makhmutovem.thread;
...
import ru.mirea.makhmutovem.thread.databinding.ActivityMainBinding;
            ...
            public void onClick(View v) {
                new Thread(new Runnable() {
                    public void run() {
                        ...
                        mainThread.setName("МОЙ НОМЕР ГРУППЫ: БИСО-02-19, НОМЕР ПО СПИСКУ: 13, МОЙ ЛЮБИМЫЙ ФИЛЬМ: 'Ла-Ла-Ленд'");
